...
strctControllers = fnAddTextSliderEditComboSmall(strctControllers, 40+30, ...
	'Grating Center Y (Pix):', 'GratingCenterY', 0, screen_size(2), [1 50], fnTsGetVar(g_strctParadigm.m_strctStimulusParams, 'GratingCenterXPix'));
strctControllers = fnAddTextSliderEditComboSmall(strctControllers, 40+30*2, ...
	'Grating Radius (Pix):', 'GratingSize', 1, min(screen_size)/2, [1 10], fnTsGetVar(g_strctParadigm.m_strctStimulusParams, 'GratingSizePix'));
